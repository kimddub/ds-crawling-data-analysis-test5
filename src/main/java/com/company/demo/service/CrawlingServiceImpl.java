...
public class CrawlingServiceImpl implements CrawlingService {
	...
	public void collectData(List<Article> articles, int siteCode, int categoryCode) {
		...
		List<String> uncrawlingArticleUrl = new ArrayList<>();
		...
		for (Article article:articles) {
			...
			try {
				...
				*/
				...
				uncrawlingArticleUrl.add(article.getWebPath());
		...
		writeHistory(" - new media: " + insertMedia
				...
				+ "\n - uninserted data(DB error):" + uncrawlingArticleUrl.size());
		
		for(String uncrawlingData:uncrawlingArticleUrl) {
